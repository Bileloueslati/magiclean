...
name="fullName"
render={({field}) => (
<Input id="fullName" label="Nom et prénom" error={!!errors.fullName} required {...field} />
)}
...
rules={{required: true}}
render={({field}) => (
<Input id="surface" type="number" label="Surface en m²" {...field} error={!!errors.surface} required />
)}
...
rules={{required: true}}
render={({field}) => (
<Input type="number" id="interventions" label="Interventions souhaitées par semaine" {...field} error={!!errors.interventions} required />
)}
...
name="informations"
render={({field}) => (
<TextArea id="informations" rows={5} label="Plus de détails" {...field} />
